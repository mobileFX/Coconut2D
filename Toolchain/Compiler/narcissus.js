...
function __init_moz_narcissus(__global)
{
	__global.moz_narcissus = {};
	__global.moz_narcissus.jsdefNames = {};
	__global.mos_jsdef = {};
	...
	for (var i = 0, j = tokens.length; i < j; i++) {
	    ...
	    tokenIds[name] = i;
	    tokens[t] = i;
	    __global.mos_jsdef[name] = i;
	    __global.moz_narcissus.jsdefNames[i] = name;
	}
	consts += ";";
	...
	function preprocess(ast)
	{
		...
		function descend(node)
		{
			...
			node.nodeName = __global.moz_narcissus.jsdefNames[node.type];
			...
			node.nodeType = __global.moz_narcissus.jsdefNames[node.type];
	...
	__global.moz_narcissus.parse = function(code, file)
	{
