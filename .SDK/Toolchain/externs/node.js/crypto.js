 ...
 * doesn't inherit directly from Cipher.
 *
 * @param {buffer.Buffer} cipher
 * @param {buffer.Buffer} password
 * @param {Object=} options
 * @constructor
 * @extends stream.Transform
 */
 ...
 * doesn't inherit directly from Cipher.
 *
 * @param {crypto.Decipheriv} cipher
 * @constructor
 * @extends stream.Transform
 */
crypto.Decipheriv = function(cipher) {};
