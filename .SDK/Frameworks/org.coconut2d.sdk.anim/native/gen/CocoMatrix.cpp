...
CocoMatrix::CocoMatrix(CocoMatrix* M)
{
	...
	__data = new Float32Array((new Array<float> ())->push(rc11)->push(rc12)->push(rc13)->push(rc14)->push(rc21)->push(rc22)->push(rc23)->push(rc24)->push(rc31)->push(rc32)->push(rc33)->push(rc34)->push(rc41)->push(rc42)->push(rc43)->push(rc44));
...
CocoMatrix::~CocoMatrix()
{
	if(__stack)
	{
		__stack = (delete __stack, nullptr);
	}
	if(__data)
	{
...
{
	__stack->push(new Float32Array((new Array<float> ())->push(rc11)->push(rc12)->push(rc13)->push(rc14)->push(rc21)->push(rc22)->push(rc23)->push(rc24)->push(rc31)->push(rc32)->push(rc33)->push(rc34)->push(rc41)->push(rc42)->push(rc43)->push(rc44)));
}
