...
CFLAGS		+= -D UNICODE -D _UNICODE -D GC_THREADS -D WIN32_THREADS -D THREAD_LOCAL_ALLOC -D PARALLEL_MARK -D _WIN32_IE=0x0500 -D WINVER=0x500 -D WIN32 -D _WINDOWS -D _CRT_SECURE_NO_DEPRECATE -D _CRT_NONSTDC_NO_DEPRECATE -D GLEW_STATIC -D CURL_STATICLIB
...
CFLAGS		+= -Wall -Wno-return-type -Wno-switch -Wno-unused-but-set-variable -Wno-sign-compare -Wno-delete-non-virtual-dtor -Wno-unused-function -Wno-unused-label -Wno-unused-parameter -Wno-unused-variable -Wunused-value -Wempty-body -Wuninitialized -Wno-comment

LDFLAGS 	+= -mwindows -static -static-libgcc -static-libstdc++ -Wl,--subsystem,windows
LDLIBS 		= -lpthread -lglew32 -lopengl32 -lcomdlg32 -lcomctl32 -luuid -loleaut32 -lole32 -lgdi32 -lfreetype -ljpeg -lpng -lz -lvorbisidec -logg -lOpenAL32 -lcurldll
