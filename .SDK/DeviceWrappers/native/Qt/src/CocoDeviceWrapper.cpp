...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CocoDeviceWrapper::CocoDeviceWrapper(int i_argc, char *i_argv[]) :  timer(this), argc(i_argc), argv(i_argv), ready(false)
{}
...
void CocoDeviceWrapper::resizeGL(int w, int h)
{
    screen.width = w;
    screen.height = h;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CocoDeviceWrapper::initializeGL()
{
}

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CocoDeviceWrapper::paintGL()
{
    if(!ready) return;
    fxCRL::paint();
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool CocoDeviceWrapper::event(QEvent* e)
{
    switch(e->type())
    {
