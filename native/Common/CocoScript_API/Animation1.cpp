...
Animation1::Animation1()
{
	...
	__root->__timeline->addKeyFrameEx(NULL, 0, 1, false, true, 0, 0, 1, 1, 0, 0, 0, 1);
	{
		CocoClip* inst1 = new CocoClip();
		inst1->__instanceName = "metal_slug1";
		__root->addChild(inst1);
		inst1->__timeline->clear();
		inst1->__timeline->addKeyFrameEx(NULL, 0, 1, false, true,  -179.5,  -111, 1, 1, 0, 0, 0, 1);
		{
			...
			inst2->__timeline->addKeyFrameEx(NULL, 0, 1, false, true, 0, 0, 1, 1, 0, 0, 0, 1);
		}
	}
}
